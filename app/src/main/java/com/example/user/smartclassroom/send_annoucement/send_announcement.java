package com.example.user.smartclassroom.send_annoucement;
...
/**
 * Created by kenonnegammad on 25/02/2018.
 */

public class send_announcement extends Fragment implements View.OnClickListener {
    View myView;
    Spinner spinner;
    EditText et_message;
    Button btnsend;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.send_announcement,container,false);
        spinner = (Spinner)myView.findViewById(R.id.spinner);
        et_message = (EditText)myView.findViewById(R.id.et_message);
        btnsend = (Button)myView.findViewById(R.id.btn_send);
    ...
    public class send_announcement_task extends AsyncTask<Void,Void,String>{
