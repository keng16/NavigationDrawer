    ...
    public ArrayList<Properties> parseSchedule(String result) {
        ...
        try {
            ...
            for (int i = 0; i < jArray.length(); i++) {
                ...
                user.setPic(json_data.getString("professor_img"));
                user.setProf_id(Integer.parseInt(json_data.getString("professor_id")));
                user.setProffname(json_data.getString("professor_name"));
