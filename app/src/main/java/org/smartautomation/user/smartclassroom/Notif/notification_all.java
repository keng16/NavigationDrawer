...
public class notification_all extends Fragment {
    View myView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.notification_all,container,false);
        listView = (ListView)myView.findViewById(R.id.list_view_notification_all);
        swipeRefreshLayout = (SwipeRefreshLayout)myView.findViewById(R.id.notification_all_swipe);
        user = getArguments().getString("user").toString();
        id = getArguments().getString("id").toString();
        MessageBox(user);
        new notification_all_task().execute();
...
//                            .replace(R.id.contentFrame_Student,view_notification)
//                            .addToBackStack(null)
//                            .commit();
//
...
//                    MessageBox(user);
//                    fragmentManager.beginTransaction()
//                            .replace(R.id.contentFrame,view_notification)
//                            .addToBackStack(null)
//                            .commit();
//                }
//            }
//        });
    ...
    public class notification_all_task extends AsyncTask<Void,Void,String>{
        @Override
        ...
        protected String doInBackground(Void... voids) {
            ...
            nameValuePairs.add(new BasicNameValuePair("offset","10"));
            try {
                //ip= new Properties();
                String Url = p.getIP()+"getAllNotification.php";
